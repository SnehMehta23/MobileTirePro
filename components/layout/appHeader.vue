<template>
  <nav class="bg-pale-gray dark:bg-gray-800 shadow-md">
      ...
      <div class="flex justify-between h-16">
        ...
        <div class="hidden lg:flex items-center space-x-4">
          ...
          <a v-if="isLogged === false"
             class="text-charcoal-gray dark:text-gray-300 hover:text-dark-charcoal dark:hover:text-white" href="/login">Log
            in</a>
