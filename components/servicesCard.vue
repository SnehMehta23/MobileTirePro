...
<template>
    <div
        ...
        <NuxtLink to="/bookings"
            class="bg-vivid-red text-white font-bold py-2 px-6 rounded-full hover:bg-crimson-red self-start mt-auto transition duration-300 shadow-lg focus:outline-none focus:ring-2 focus:ring-vivid-red focus:ring-offset-2 inline-block no-underline">
            Check Availability
        </NuxtLink>
    </div>
</template>
