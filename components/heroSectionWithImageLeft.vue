...
import CarSelectorForm from '/components/carSelectorForm.vue'
...
const services = [
    ...
    },
    {
        ...
        icon: '/images/seasonIcon.svg'
    }
]
</script>

<template>
    <div class="relative overflow-hidden bg-gray-100 min-h-[70vh] lg:min-h-0 hero-bg">
        ...
        <div class="container mx-auto px-4 py-8 h-full relative z-10">
            <div class="flex flex-col lg:flex-row items-center justify-center lg:justify-between h-full">
                <div class="hidden lg:block lg:w-7/12">
                    <img src="/images/isometric-car-repair-horizontal-banner-with-serviceman-making-tire-service-vector-illustration.png"
                ...
                <div
                    ...
                    <h1
                        class="text-3xl lg:text-5xl font-bold text-white mb-4 text-shadow lg:text-gray-800 lg:text-shadow-none">
                        Expert Tire Care, Wherever You Are
                    </h1>
                    <p class="text-lg lg:text-xl text-gray-100 lg:text-gray-600 mb-6 text-shadow lg:text-shadow-none">
    ...
    <div class="container mx-auto px-4 py-12">
        <div class="bg-gradient-to-r from-pale-red to-vivid-red rounded-lg shadow-lg p-8 mb-12">
...
@media (max-width: 1023px) {
    .hero-bg {
        background-image: url('/images/undraw_automobile_repair_ywci.png');
