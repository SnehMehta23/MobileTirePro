    ...
    <div class="container mx-auto px-4 py-8 h-full relative z-10">
      <div class="flex flex-col lg:flex-row items-center justify-center lg:justify-between h-full">
        <div class="hidden lg:block lg:w-7/12">
          <img
              src="/images/isometric-car-repair-horizontal-banner-with-serviceman-making-tire-service-vector-illustration.png"
        ...
        <div
          ...
          <p class="text-lg dark:text-white lg:text-xl text-gray-100 lg:text-gray-600 mb-6 text-shadow lg:text-shadow-none">
